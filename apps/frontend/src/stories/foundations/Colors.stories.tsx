...
function ColorSwatch({
  ...
  return (
    <div className="flex flex-col gap-2">
      <div
        className="h-32 w-32 rounded-lg border border-border-primary shadow-glass"
...
export const BrandColors: StoryObj = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="mb-6 text-lg font-semibold text-text-primary">Brand Colors</h3>
...
export const BackgroundColors: StoryObj = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="mb-6 text-lg font-semibold text-text-primary">Background Colors</h3>
...
export const TextColors: StoryObj = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="mb-6 text-lg font-semibold text-text-primary">Text Colors</h3>
        <div className="grid grid-cols-3 gap-8">
...
export const StateColors: StoryObj = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="mb-6 text-lg font-semibold text-text-primary">State Colors</h3>
        <div className="grid grid-cols-3 gap-8">
          <div>
            <ColorSwatch
              name="Success"
...
export const BorderAndEffects: StoryObj = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="mb-6 text-lg font-semibold text-text-primary">Borders & Effects</h3>
        <div className="space-y-6">
          <div>
            <p className="mb-3 text-sm text-text-secondary">Glass Border (10% white opacity)</p>
            <div className="flex h-12 w-48 items-center justify-center rounded-lg border border-border-primary shadow-glass">
              <span className="text-sm text-text-muted">rgba(255,255,255,0.1)</span>
            </div>
          </div>
          <div>
            <p className="mb-3 text-sm text-text-secondary">Cyan Glow Effect</p>
            <div
          ...
          <div>
            <p className="mb-3 text-sm text-text-secondary">Teal Glow Effect</p>
            <div
              className="flex h-12 w-48 items-center justify-center rounded-lg"
              style={{
  ...
  render: () => (
    <div className="w-full max-w-4xl space-y-12">
      <div>
        ...
        <div className="space-y-8">
          <div>
            <h3 className="mb-4 text-lg font-semibold text-text-primary">Brand Colors</h3>
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-text-primary">Backgrounds</h3>
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-text-primary">Text</h3>
            <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-text-primary">Semantic States</h3>
            <div className="grid grid-cols-3 gap-6">
