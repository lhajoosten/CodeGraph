  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-4xl space-y-12">
        <div>
          <h1 className="text-text-primary-lum mb-2 text-3xl font-bold">Spacing System</h1>
          ...
          {spacingValues.map((space) => (
            <div key={space.name} className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-text-primary-lum font-semibold">{space.name}</p>
                  <p className="text-text-secondary-lum text-sm">{space.value}</p>
                </div>
                <p className="text-text-muted-lum font-mono text-xs">{space.tailwind}</p>
              </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-text-secondary-lum mb-3 text-sm font-medium">
                Padding - Internal spacing in components
              </p>
              <div className="grid grid-cols-3 gap-4">
                <div className="border-border-steel bg-bg-elevated-lum rounded-lg border p-2">
                  <p className="text-text-muted-lum text-xs">Compact (p-2)</p>
                </div>
                <div className="border-border-steel bg-bg-elevated-lum rounded-lg border p-4">
                  <p className="text-text-muted-lum text-xs">Default (p-4)</p>
                </div>
                <div className="border-border-steel bg-bg-elevated-lum rounded-lg border p-6">
                  <p className="text-text-muted-lum text-xs">Spacious (p-6)</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="bg-bg-elevated-lum rounded-lg p-3">
                  <p className="text-text-muted-lum text-xs">Item 1</p>
                </div>
                <div className="bg-bg-elevated-lum rounded-lg p-3">
                  <p className="text-text-muted-lum text-xs">Item 2 (space-y-2)</p>
                </div>
              </div>
              <div className="mt-4 space-y-4">
                ...
                <div className="bg-bg-elevated-lum rounded-lg p-3">
                  <p className="text-text-muted-lum text-xs">Item 2 (space-y-4)</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-text-muted-lum mb-2 text-xs">Gap-2</p>
                ...
                <div>
                  <p className="text-text-muted-lum mb-2 text-xs">Gap-4</p>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6 text-sm">
            <div className="border-border-steel rounded-lg border p-4">
              <p className="text-text-primary-lum mb-2 font-semibold">Form Elements</p>
            ...
            <div className="border-border-steel rounded-lg border p-4">
              <p className="text-text-primary-lum mb-2 font-semibold">Cards & Containers</p>
              <ul className="text-text-secondary-lum list-inside space-y-1">
            ...
            <div className="border-border-steel rounded-lg border p-4">
              <p className="text-text-primary-lum mb-2 font-semibold">Navigation</p>
              <ul className="text-text-secondary-lum list-inside space-y-1">
                <li>• Nav items: p-3</li>
            ...
            <div className="border-border-steel rounded-lg border p-4">
              <p className="text-text-primary-lum mb-2 font-semibold">Page Layout</p>
              <ul className="text-text-secondary-lum list-inside space-y-1">
        ...
        <section className="space-y-6">
          ...
          <div className="border-border-steel space-y-4 rounded-lg border p-6">
            {/* Header */}
            <div className="border-border-steel border-b pb-4">
              <p className="text-text-primary-lum text-lg font-semibold">Task Details</p>
            ...
            {/* Actions */}
            <div className="border-border-steel flex gap-2 border-t pt-4">
...
export const ResponsiveSpacing: StoryObj = {
  render: () => (
    <div className="w-full max-w-4xl space-y-8">
      <div>
        <h2 className="text-text-primary-lum mb-4 text-2xl font-bold">Responsive Spacing</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="border-border-steel rounded-lg border p-4 md:p-6 lg:p-8">
          <p className="text-text-secondary-lum">
        ...
        <div className="space-y-2 md:space-y-3 lg:space-y-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-bg-elevated-lum rounded-lg p-3 md:p-4">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:gap-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="rounded-lg bg-brand-cyan/20 p-4 text-center">
              <p className="text-text-secondary-lum text-xs">Grid Item {i + 1}</p>
            </div>
          ))}
        </div>
      </div>
