...
export const GlowEffects: StoryObj = {
  render: () => (
    <div className="w-full max-w-3xl space-y-12">
      <div>
        <h2 className="text-text-primary-lum mb-8 text-xl font-semibold">Glow Effects</h2>

        <div className="space-y-8">
          <div>
            <p className="text-text-secondary-lum mb-4 text-sm">
...
export const Shadows: StoryObj = {
  render: () => (
    <div className="w-full max-w-3xl space-y-12">
      <div>
        <h2 className="text-text-primary-lum mb-8 text-xl font-semibold">Shadows</h2>
        ...
        <div className="space-y-8">
          <div>
            ...
            <div
              className="bg-bg-steel flex h-24 w-48 items-center justify-center rounded-lg"
              style={{ boxShadow: 'var(--shadow-glass)' }}
            >
              <span className="text-text-secondary-lum text-sm">Glass Border</span>
            </div>
            <p className="text-text-muted-lum mt-2 font-mono text-xs">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <div className="bg-bg-steel flex h-24 w-48 items-center justify-center rounded-lg shadow-lg">
                <span className="text-text-secondary-lum text-sm">Elevated Card</span>
              </div>
              <div className="space-y-2 text-sm">
                <p className="text-text-secondary-lum">
...
export const Glassmorphism: StoryObj = {
  render: () => (
    <div className="w-full max-w-3xl space-y-12">
      <div>
        <h2 className="text-text-primary-lum mb-8 text-xl font-semibold">Glassmorphism</h2>

        <div className="from-bg-secondary-lum via-bg-primary-lum to-bg-secondary-lum relative h-96 w-full overflow-hidden rounded-lg bg-gradient-to-br">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-8">
            <div className="w-full max-w-xs space-y-6">
              <div
                className="border-border-steel rounded-lg border p-6"
                style={{
        ...
        <div className="mt-8 space-y-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-text-primary-lum mb-1 font-semibold">Backdrop Blur</p>
              <p className="text-text-secondary-lum">Subtle blur creates depth and hierarchy</p>
            </div>
            <div>
              <p className="text-text-primary-lum mb-1 font-semibold">Transparency</p>
              <p className="text-text-secondary-lum">Background slightly visible for context</p>
            </div>
            <div>
              <p className="text-text-primary-lum mb-1 font-semibold">Glass Border</p>
              <p className="text-text-secondary-lum">1px white border adds definition</p>
            </div>
            <div>
              <p className="text-text-primary-lum mb-1 font-semibold">Use Cases</p>
...
export const FocusStates: StoryObj = {
  render: () => (
    <div className="w-full max-w-3xl space-y-12">
      <div>
        <h2 className="text-text-primary-lum mb-8 text-xl font-semibold">Focus States</h2>
        ...
        <div className="space-y-8">
          <div>
            ...
            <input
              ...
              className="border-border-default-lum bg-bg-steel text-text-primary-lum w-full rounded-lg border px-4 py-3 focus:border-brand-cyan focus:shadow-[0_0_8px_rgba(34,211,238,0.3)] focus:outline-none"
              autoFocus
            />
          </div>
          ...
          <div>
            ...
            <p className="text-text-muted-lum mt-2 text-xs">Press Tab or click to see focus ring</p>
          </div>
          ...
          <div>
            ...
            <p className="text-text-muted-lum mt-2 text-xs">Tab to this link to see focus state</p>
          </div>
        </div>
      </div>
    </div>
...
export const CompleteEffectsSystem: StoryObj = {
  render: () => (
    <div className="w-full max-w-4xl space-y-12">
      <div>
        <h1 className="text-text-primary-lum mb-2 text-3xl font-bold">Effects & Visual Styling</h1>
        <p className="text-text-secondary-lum">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <p className="text-text-primary-lum mb-1 font-semibold">Glass Border</p>
            <p className="text-text-muted-lum text-xs">10% white opacity edge</p>
          </div>
          <div className="rounded-lg border-2 border-brand-cyan p-6 text-center">
            <p className="text-text-primary-lum mb-1 font-semibold">Colored Border</p>
            <p className="text-text-muted-lum text-xs">Cyan accent border</p>
          </div>
        </div>
      </section>
    </div>
