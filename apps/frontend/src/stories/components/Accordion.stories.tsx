  ...
  render: (args) => (
    <Accordion {...args} className="w-full max-w-md">
      <AccordionItem value="features">
        ...
        <AccordionContent>
          <ul className="text-text-secondary list-inside space-y-1 text-sm">
        ...
        <AccordionContent>
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-text-primary font-medium">Create a task</p>
                <p className="text-text-secondary text-sm">Describe what you want built</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex h-6 w-6 items-center justify-center rounded-full bg-brand-cyan/20 text-xs font-bold text-brand-cyan">
              ...
              <div>
                <p className="text-text-primary font-medium">Review the plan</p>
                <p className="text-text-secondary text-sm">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-text-primary font-medium">Monitor progress</p>
                <p className="text-text-secondary text-sm">
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          <div className="grid grid-cols-2 gap-4">
            <div className="border-border-primary bg-surface rounded-lg border p-3">
              <p className="text-text-primary font-medium">⚡ Faster Development</p>
              <p className="text-text-secondary text-xs">Cut development time in half</p>
            </div>
            <div className="border-border-primary bg-surface rounded-lg border p-3">
              <p className="text-text-primary font-medium">✓ Higher Quality</p>
              <p className="text-text-secondary text-xs">Automated testing & review</p>
            </div>
            <div className="border-border-primary bg-surface rounded-lg border p-3">
              <p className="text-text-primary font-medium">🎯 Consistent</p>
              <p className="text-text-secondary text-xs">Reliable, predictable results</p>
            </div>
            <div className="border-border-primary bg-surface rounded-lg border p-3">
              <p className="text-text-primary font-medium">🔄 Flexible</p>
              <p className="text-text-secondary text-xs">Easy revisions & iterations</p>
            </div>
          </div>
        </AccordionContent>
      </AccordionItem>
