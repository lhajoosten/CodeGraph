  ...
  return (
    <div className="space-y-4">
      <div className="text-center">
        ...
        <p className="text-sm text-text-secondary">{t('luminous.twoFactor.verify.subtitle')}</p>
      </div>
      ...
      {!useBackupCode && (
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-teal py-3 font-semibold text-white shadow-glow-teal transition-all hover:shadow-[0_0_20px_rgba(45,212,191,0.6)] active:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          >
