...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-background-2 p-1 text-text-primary shadow-modal',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive && 'text-danger focus:bg-danger-100 focus:text-danger',
      className
    )}
    {...props}
  />
